...
public class Checker {
    ...
    public static Checker create(String automationFile, String LTLExpression) {
        ...
        final LTLExpression expression = new Negation(LTLExpressionBuilder.build(LTLExpression));
        final BuchiAutomaton buchi = BuchiAutomaton.fromAutomation(automaton);
        final GeneralizedLabeledBuchiAutomaton glba = GeneralizedLabeledBuchiAutomaton.fromLTLExpression(expression, buchi.atomPropositions);
...
//        }
    ...
    private static Map<Symbol, List<Node>> ConstantructLoop(final Node state) {
